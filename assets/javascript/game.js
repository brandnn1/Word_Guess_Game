...
//functions for a win, a loss, and/or a reset
 function winnerFunction() {
    document.getElementById("winwin").style.visibility = "visible";
     audio1.play();
     audio1.volume = 0.05;
     audio2.play();
     audio1.volume = 0.05;
 ...
 function loserFunction() {
   if (guessesRemaining === 0) {
    ...
    document.getElementById("loselose").style.visibility = "visible";
    audio3.play();
    audio3.volume = 0.05;
    gameFinished = true;
    }
